...
### ✨ Highlights
Initial release of DMesh Studio, which is an evolution from [DMesh Viewer](https://github.com/open-data-mesh/dmesh-viewer)

### 🎨 UI & Theming
- Introduced multi-environment UI customization (see [dmesh-studio-custom-sample](https://github.com/open-data-mesh/dmesh-studio-custom-sample)).
